...
Type
  ...
  function __mingw_vsnprintf(str:pansichar;count:ptrint;format:pansichar{;Args:Array of const}):longint; cdecl;
  function __mingw_vsprintf(str:pansichar;format:pansichar{;Args:Array of const}):longint; cdecl;
  function __mingw_vsscanf(str:pansichar;format:pansichar{;Args:Array of const}):longint; cdecl;
  ...
  function vsprintf_crt(str:pansichar;format:pansichar;const v:array of const):longint; cdecl; external name 'vsprintf';
  function vsscanf_crt(str:pansichar;count:ptrint;format:pansichar;const v:array of const):longint; cdecl; external name 'vsscanf';

  function __mingw_vsnprintf(str:pansichar;count:ptrint;format:pansichar{;Args:Array of const}):longint; cdecl; assembler; [alias: PREFIX + '__mingw_vsnprintf']; nostackframe;
  asm
   jmp vsnprintf_crt
  end;

  function __mingw_vsprintf(str:pansichar;format:pansichar{;Args:Array of const}):longint; cdecl; assembler; [alias: PREFIX + '__mingw_vsprintf']; nostackframe;
  asm
   jmp vsprintf_crt
  end;

  function __mingw_vsscanf(str:pansichar;format:pansichar{;Args:Array of const}):longint; cdecl; assembler; [alias: PREFIX + '__mingw_vsscanf']; nostackframe;
  asm
   jmp vsscanf_crt
  end;
  ...
  function udivdi3(num, den: uint64): uint64; cdecl;
    {$ifdef FPC} public name PREFIX + '__udivdi3'; {$endif}
  begin
    result := num div den;
  end;
  ...
  function udivmoddi4(a, b: UInt64; var c: UInt64): UInt64; cdecl;
    {$ifdef FPC} public name PREFIX + '__udivmoddi4'; {$endif}
  {$ifdef CPU32}
  var
    q, r: cardinal;
  {$endif CPU32}
